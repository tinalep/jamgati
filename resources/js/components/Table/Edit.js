                            ...
                            <div className="edit-card__section">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <input data-table='unfusion' onClick={props.tableHandler} className="border-0 bg-transparent" type="image" src={svgUrl+'../../resources/assets/images/unfusion-button.svg'}/>
                                    </div>
                                </div>
                            </div>
                            <div className="edit-card__section">
