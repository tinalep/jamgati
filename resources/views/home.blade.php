                    ...
                    <div class="col-12 advantage">
                        <div class="d-flex align-items-center">
                            <div class="illustration w-lg-50">
                                <img src="assets/images/img-upload.png" loading="lazy" alt="Importez vos fichiers"
                                    longdesc="#introductionIMG">
                            </div>
                            <div class="w-lg-50 offset-lg-1">
                                <div class="content">
                                    <h3>Importez vos fichiers</h3>
                                    <p id="introductionIMG">
                                        L’application Jamgati vous permet de créer l’élément que vous souhaitez à partir
                                        d’un fichier existant. Que ce soit à partir d’un fichier texte pour la création
                                        d’un tableau ou encore suite à un fichier de type Json, Jamgati vous offre un
                                        large panel de choix de conception. Cette fonctionnalité n’est néanmoins
                                        disponible qu’après vous être inscrit et identifié.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="w-lg-50">
                                <div class="content">
                                    ...
                                    <p id="modelIMG">
                                        Vous manquez d’inspiration ou vous ne savez pas comment mettre en forme vos
                                        données ? Connectez vous et un certain nombre de modèles de base vous seront
                                        présentés pour vous faire gagner du temps. Du formulaire de contact jusqu’à la
                                        liste des courses, trouvez votre bonheur dans notre liste de modèles.
                                    </p>
                                </div>
                            </div>
                            <div class="illustration w-lg-50 offset-lg-1">
                                <img src="assets/images/img-form.png" loading="lazy" alt="Formulaires"
                                    longdesc="#modelIMG">
                            </div>
                        </div>
                    </div>
        ...
        <div class="section tools-home">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="w-75 m-auto text-center mt-50">
                            En un clin d’oeil, Jamgati créé l’élément que vous souhaitez. Grâce à son interface
                            intuitive, vous pourrez créer autant d'objets que vous le souhaitez, rapidement et
                            efficacement.
                            Grâce à Jamgati, gagnez du temps sur votre projet web : tout est ici à votre disposition et
                            fait pour vous aider à créer du code en un instant. Pas besoin d’avoir des compétences
                            professionnelles en développement web pour pouvoir créer du contenu. Fini les recherches
                            interminables et les vidéos tutorielles pour comprendre comment utiliser tel plugin pour
                            créer un tel contenu. Tout est ici à portée de main, créé pour vous et pour tous.
                        </p>
                    </div>
                </div>
                <div class="row justify-content-between cards-home">
                    <div class="card">
                        <h3>Accessible</h3>
                        <p>Jamgati porte une grande attention à l’accessibilité dans le but de donner la possibilité à
                            tous d’utiliser votre site.</p>
                    </div>
                    <div class="card">
                        <h3>Open source</h3>
                        <p>Une remarque ou une question ? Dirigez vous vers le footer pour accéder à notre Git et nous
                            permettre de faire évoluer notre application web.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 tech">
                        ...
                        <div class="text" id="htmlIMG">
                            ...
                            <p>Pour pouvoir mettre en forme votre contenu, Jamgati utilise la technologie HTML5,
                                nécessaire pour intégrer les éléments proposés</p>
                        </div>
                    </div>
                    <div class="col-md-6 tech">
                        ...
                        <div class="text" id="cssIMG">
                            ...
                            <p>Pour une agréable mise en forme de vos éléments. Ajouter vos couleurs, typographies ou
                                encore taille de texte pour une personnalisation la plus complète possible.</p>
                        </div>
                    </div>
                    <div class="col-md-6 tech">
                        <img src="assets/images/img-bootstrap.png" loading="lazy" alt="Logo Bootstrap"
                            longdesc="#bootIMG">
